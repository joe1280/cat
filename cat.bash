...
echo
echo "请输入您想设置的后台管理员用户名(回车默认Dmguser)："
read adminuser
if [[ -z $adminuser ]]
then
adminuser=Dmguser
...
echo
echo "请输入您想设置的后台管理员密码(回车默认Dmgpass)："
read adminpass
if [[ -z $adminpass ]]
then
adminpass=Dmgpass
...
echo
echo
echo '欢迎使用大猫哥免流™Openvpn云免' >>info.txt
echo "
...
clear
echo -e '\033[33m========================================================================\033[0m'
echo -e '\033[33m│ ☆-大喵哥一键搭建脚本           										  \033[0m'
...
echo -e '\033[33m│ ☆-回车进入搭建脚本   ------>  		  								      \033[0m'
echo -e '\033[33m│\033[0m'
read
echo 
authentication
...
clear
echo -e '\033[33m==========================================================================\033[0m'
echo -e '\033[31m☆-大猫哥云免流控\033[0m'
echo -e '\033[31m☆-温馨提示：\033[0m'
echo -e '\033[31m☆-为了您服务器的稳定和安全，请勿非法破解改程序\033[0m'
echo -e '\033[31m☆-支持正版，抵制盗版\033[0m'
echo -e '\033[31m☆-秘钥绑定IP可在同一IP下反复使用！\033[0m'
echo -e '\033[33m==========================================================================\033[0m'
echo -e '\033[33m请输入正版秘钥：\033[0m'
read card
echo
echo "正在获取授权码..."
...
echo -e '\033[33m==========================================================================\033[0m'
echo -e '\033[31m☆-秘钥错误 请检查授权码是否输入正确！\033[0m'
echo -e '\033[31m☆-温馨提示：\033[0m'
echo -e '\033[31m☆-正版秘钥8.88一个\033[0m'
echo -e '\033[31m☆-支持正版，抵制盗版\033[0m'
echo -e '\033[31m☆-秘钥绑定IP可在同一IP下反复使用！\033[0m'
echo -e '\033[33m==========================================================================\033[0m'
		sleep 4
